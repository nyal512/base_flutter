...
#ifndef BASE_FLUTTER_SWIFT_H
#define BASE_FLUTTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="base_flutter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC12base_flutter11AppDelegate")
...
SWIFT_CLASS("_TtC12base_flutter17MainFlutterWindow")
